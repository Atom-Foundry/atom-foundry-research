...
This directory contains the public research reports published by Atom Foundry.
...
Our flagship report combines the major cross-category recommendation experiments into a single analysis.

| Report | Description |
|---|---|
| **The State of AI Recommendations Across Commerce 2026** | Cross-category analysis of AI recommendation behavior across five ecommerce industries. |
...
Identical recommendation experiments repeated across multiple ecommerce industries.
...
Individual report packages may contain:
